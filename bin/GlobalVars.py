...
#InFile=['NMC100']
AddFnO=True
#ListOfStocks = 'BHEL.NS' #INFRATEL.NS
...
Patterns = {'RSIMAMinMax':False,'RSICDBO':True, 'RSIDiverg':True,
            'SellAtLMP': False, 'PerLevelBS': True, 'MA': False, 'RSIMA':False}
...
RepFiles={'UnSortData':'UnSortDataInd.csv', 'DataWInd':'StockDataInd.csv', 
    ...
    'ToTrade':'RSIDiverg.csv', 'Attrib':'Attrib.csv','DailyFnO':'FnO', 'LiveGraph':'LG',
    'DaysInfo':'DaysInfo'}  
...
NSEZone = tz.gettz('Asia/Calcutta')
NYSEZone = tz.gettz('America/New_York')
DTab=['Stock','Lot','LSize','MCap','FnOBan','HDivY','RSI','YLHP','LRm5','SDP5','LRm10','SDP10','Close','DClose2P', 'DClose1P','DHigh1P','DLow1P']
ConvToInt=['Lot','MCap','RSI','YLHP']
DTabDisp=['Stock','Lot','LSize','MCap','Ban','HDiv','RSI','YLH%','LRm5','SD5%','LRm10','SD10%','Close','Close2%','Close%','High%','Low%']
HighDiv=['COALINDIA','IOC','RECLTD','PFC','NMDC','SJVN','HINDPETRO','OFSS','NHPC','NTPC','POWERGRID']